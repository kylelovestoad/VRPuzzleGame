...
public class ChunkTests
{
    ...
    public void MakesChunkWithSinglePieceInitially()
    {
        ...
        _chunk.InitializeVariant(solutionLocation, _simpleMesh, _simpleMaterial);
    ...
    public void UpdatesChunkSizeWhenMorePiecesAdded()
    {
        ...
        _chunk.InitializeVariant(solutionLocation, mesh, _simpleMaterial);
    ...
    public void CombiningChunks()
    {
        ...
        otherChunk.InitializeVariant(new Vector3(1, 0, 0), mesh, _simpleMaterial);
