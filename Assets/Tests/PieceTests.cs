...
//
//         _piece.InitializePiece(solutionLocation, testMesh, testMaterial);
//
...
//
//         _piece.InitializePiece(pieceSolLocation, mesh, material);
//         otherPiece.InitializePiece(otherSolLocation, mesh, material);
//
