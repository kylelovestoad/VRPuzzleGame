...
namespace Tests
{
    public class PieceTests
    {
        ...
        public void MeshSet()
        {
            ...
            var pieceCut = new PieceCut(0,new List<int>(), solutionLocation, vertices);
        ...
        public void ExactSolutionLocation()
        {
            ...
            var pieceNeighbors = new List<int> { 1 };
            var otherNeighbors = new List<int> { 0 };
        
            var pieceCut = new PieceCut(0, pieceNeighbors, pieceSolLocation, vertices);
            var otherPieceCut = new PieceCut(1, otherNeighbors, otherSolLocation, vertices);
            var pieceCuts = new List<PieceCut> { pieceCut };
