...
namespace Tests
{
    public class PieceTests
    {
        ...
        public void MeshSet()
        {
            ...
            var pieceCut = new PieceCut(0, solutionLocation, vertices);
        ...
        public void ExactSolutionLocation()
        {
            ...
            var pieceCut = new PieceCut(0, pieceSolLocation, vertices);
            var otherPieceCut = new PieceCut(1, otherSolLocation, vertices);
            var pieceCuts = new List<PieceCut> { pieceCut };
