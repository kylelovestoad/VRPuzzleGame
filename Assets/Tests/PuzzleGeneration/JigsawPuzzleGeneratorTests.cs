...
namespace Tests
{
    public class JigsawPuzzleGeneratorTests
    {
        ...
        public async Task GeneratesCorrectPieceDimensions()
        {
            ...
            var renderData = await _generator.Generate(image, 2, 4, 1f);
        ...
        public async Task GeneratesCorrectNumberOfPieces()
        {
            ...
            var renderData = await _generator.Generate(image, rows, cols, 1f);
            var layout = renderData.Layout;
        ...
        [Test]
        public async Task EdgesHaveLessVertices()
        {
            int rows = 3;
            int cols = 4;
        ...
        [Test]
        public async Task CornersAndEdgesAssignedCorrectly()
        {
            int rows = 3;
            int cols = 4;
