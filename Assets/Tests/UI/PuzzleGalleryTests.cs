...
namespace Tests.UI
{
    public class PuzzleGalleryTests
    {
        ...
        private PuzzleOnlineGalleryTile _onlineTilePrefab;
        private Toggle _localTab;
        private Toggle _onlineTab;
        private Button _onCreateOption;
        ...
        public void SetUp()
        {
            ...
            _onlineTilePrefab = new GameObject("OnlineTilePrefab").AddComponent<PuzzleOnlineGalleryTile>();
            galleryType.GetField("puzzleOnlineGalleryItemPrefab", flags).SetValue(_puzzleGallery, _onlineTilePrefab);
            ...
            _onCreateOption = new GameObject("OnCreateOption").AddComponent<Button>();
            galleryType.GetField("onCreateOption", flags).SetValue(_puzzleGallery, _onCreateOption);
        }
        ...
        public void TearDown()
        {
            ...
            Object.DestroyImmediate(_onlineTilePrefab.gameObject);
            Object.DestroyImmediate(_localTab.gameObject);
            Object.DestroyImmediate(_onlineTab.gameObject);
            Object.DestroyImmediate(_onCreateOption.gameObject);
