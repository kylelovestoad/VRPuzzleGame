...
namespace PuzzleGeneration
{
    public static class PieceMeshGenerator
    {
        ...
        /**
         * Credit: Ear clipping algorithm made based on: https://www.geometrictools.com/Documentation/TriangulationByEarClipping.pdf
         * Runs in O(n^3) time for now for simplicity to just get working, can improve to O(n^2) according to article
         */
